    ...
    return (
        <div className='relative'>
            ...
            <label
                ...
                ${getSize(size)} -top-2 peer-placeholder-shown:top-2.5 peer-focus:-top-2
                peer-required:after:content-['\\00a0*'] peer-invalid:after:text-pink-500 peer-focus:cursor-default
                peer-focus:text-primary-500 peer-disabled:cursor-not-allowed peer-disabled:text-slate-400 peer-disabled:before:bg-transparent`}
            >
                {label}
            </label>
